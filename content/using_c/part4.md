...
Here's the complete c code for this part:

{{< code title="part4.c" file="/content/using_c/code/part4.c" language="c" >}}


And we added tests:

{{< code title="part4.rb" file="/../../tests//part4.rb" language="rb" >}}
